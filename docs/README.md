...
58. `image-skill-platform-consumer-components-v1.md`
59. `image-skill-platform-consumer-interactions-v1.md`
60. `image-skill-platform-consumer-copy-v1.md`
61. `image-skill-platform-consumer-layout-decisions-v1.md`
62. `development-workflow.md`
63. `testing-strategy.md`
64. `troubleshooting.md`
65. `current-project-status.md`
